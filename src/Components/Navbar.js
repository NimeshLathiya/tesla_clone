      ...
      <div className="hidden lg:inline">
        <ul className="flex justify-center hover:cursor-pointer">
          <li className="py-1 px-3 hover:rounded hover:bg-black/5">
            <a href="https://www.tesla.com/models">Modal S </a>
          </li>
          <li className="py-1 px-3 hover:rounded hover:bg-black/5">
            <a href="https://www.tesla.com/model3">Modal 3 </a>
          </li>
          <li className="py-1 px-3 hover:rounded hover:bg-black/5">
            <a href="https://www.tesla.com/modelx">Modal X </a>
          </li>
          <li className="py-1 px-3 hover:rounded hover:bg-black/5">
            <a href="https://www.tesla.com/modely">Modal Y </a>
          </li>
          <li className="py-1 px-3 hover:rounded hover:bg-black/5">
